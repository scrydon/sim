    ...
    >
      ...
      <div className='flex w-full flex-col gap-12 md:grid md:grid-cols-2 md:grid-rows-1 lg:grid-cols-3'>
        ...
        >
          <BlogCard
            href='/blog/test'
            title='How to Build an Agent in 5 Steps with scrydon.eu'
            description="Learn how to create a fully functional AI agent using scrydon.eu's unified API and workflows."
